...
Status: **Stage 1 and BL-001 through BL-005 are merged. BL-006's four-state resident interface is implemented on a focused branch and pending human review.**
