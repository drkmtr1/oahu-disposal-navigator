...
Status: **Stage 1 documentation candidate pending human approval, final commit, and push; no application has been implemented.**
...
Start with [AGENTS.md](AGENTS.md), the [project overview](docs/PROJECT_OVERVIEW.md), and the [UX design](docs/UX_DESIGN.md). The original [PROJECT_HANDOFF.md](PROJECT_HANDOFF.md) is preserved as historical context. Candidate documents become the approved Stage 1 foundation only after human approval, final commit, and push.
