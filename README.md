...
Status: **Stage 1 and BL-001 through BL-008 are merged. BL-009's bounded model experiment failed the mandatory critical-safety gate and proposes deterministic-only V1; it is pending CI and human review.**
